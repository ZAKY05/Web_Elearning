                ...
                <div class="card stretch stretch-full">
                    <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <h5 class="card-title mb-0" style="font-size:1.05rem;">
                            <i class="feather-users me-2 text-primary" style="font-size:1.15rem;"></i> Data Akun Siswa
                        </h5>
                                ...
                                <tbody id="Tabelsiswaakun">
                                    @foreach ($gurus as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge {{ $data->jenis_kelamin === 'L' ? 'bg-soft-info text-info' : 'bg-soft-danger text-danger' }}"
    ...
    <script>
        ...
        document.querySelectorAll('.btn-edit-guru').forEach(function(btn) {
            btn.addEventListener('click', function() {
                ...
                document.getElementById('editJenisKelamin').value = this.dataset.jenis_kelamin || '';
                ...
                document.getElementById('formEditGuru').action = '{{ url('admin/akun-guru') }}/' + id;
            });
        });
        ...
        document.querySelectorAll('.btn-hapus-guru').forEach(function(btn) {
            btn.addEventListener('click', function() {
                ...
                document.getElementById('formHapusGuru').action = '{{ url('admin/akun-guru') }}/' + this.dataset.id;
            });
        });
